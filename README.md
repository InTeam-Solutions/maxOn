...
MAX-бот на базе микросервисной архитектуры с контекстно-осведомленным AI агентом.


## Для быстрого запуска перейдите в ./local-install/README.md
...
5. **API Gateway** - MAX bot с rich HTML рендерингом
